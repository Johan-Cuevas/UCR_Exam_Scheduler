...
## Purpose
Provide a modern, searchable web interface for students to find their final exam schedules. The frontend allows searching by course number and name, filtering by date and location, and displays results in a paginated table.
